...
var CatEngineService = /** @class */ (function () {
    ...
    CatEngineService.prototype.analyzeCatScore = function (userScore, userCategory) {
        return __awaiter(this, void 0, void 0, function () {
            var models, results, _i, models_1, model, cutoff, compositeScore, classification;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        cutoff = _a.sent();
                        compositeScore = this.calculateCompositeScore(userScore);
    ...
    CatEngineService.prototype.calculateCompositeScore = function (userScore) {
    ...
    CatEngineService.prototype.classifyChance = function (compositeScore, historicalCutoff) {
        if (!historicalCutoff)
            return 'Unknown';
        if (compositeScore >= historicalCutoff * 1.1)
            return 'High';
